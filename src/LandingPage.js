...
const LandingPage = () => {
    ...
    return (
        <div
            className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-blue-100 via-white to-blue-100">
            {showResponseCard && (
                <ResponseCard
                    text={responseText}
                    loading={loading}
            ...
            <div className="w-full max-w-md p-8 space-y-4 bg-white rounded-lg shadow-xl">
                ...
                <Modal
                    ...
                    className="relative w-full p-6 mx-auto mt-10 bg-white rounded shadow-xl outline-none max-w-md md:max-w-3xl"
